...
import { boiler_plant, boiler_water_corrosion, chiller, cooling_tower, corrosion_products, descaling_products, dmplant, fouling_products, frp_pressure_vessels, microbiological_contaminants, pecialitys_chemical, revers_osmosis, ro_plant, sand_filter, scale_products, scaling_water_corrosion, slide_1, string_cartridge, sugar_factory, uv_disinfection, water_kit, water_softner } from "@/public";
...
export const aboutData = {
  ...
  divisions: [
    ...
    },
    {
      ...
      description:
        "Complete range of water treatment systems including sand filters, softening plants, DM plants, RO systems, UV disinfection systems, Automatic Water Softening Systems for domestic use. — all under the UNITREAT® brand.",
      icon: "Settings",
      color: "#0096C7",
    },
    {
...
export const chemicalProducts = [
  ...
  },
  {
    ...
    chemicals: [
      ...
      { code: "b", name: "UNI-TREAT®", type: "Flocculants (Anionic, Cationic, Non-ionic)" },
...
export const mechanicalProducts = [
  ...
  },
  {
    ...
    models: [
      ...
      { model: "UNITREAT® 3236", flow: "10 to 20 m³/hr", resinCap: "1000 Ltrs" },
    ],
    icon: "Droplets",
    color: "#0096C7",
  },
